"""MCP Salesforce client - self-contained (for reuse in other projects).

This file merges the three modules used in the original project
(mcp_salesforce.py + resilience/retry.py + resilience/rate_limit.py) into a
single import-free file so it can be dropped into any project as-is.
...
pipeline/run_with_rotation.py and workflow/collect.yml in this kit).
